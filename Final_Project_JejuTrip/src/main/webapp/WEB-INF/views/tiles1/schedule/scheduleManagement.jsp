     ...
     //	googleCalendarApiKey : "자신의 Google API KEY 입력",
        /*
           ...
           14. "API  API 및 서비스" 에서 "라이브러리" 를 클릭한다.
               ...
               "사용" 버튼을 클릭한다. 
        */
    	googleCalendarApiKey : "AIzaSyDzEfMvdaVGjQZ28y9EgiXv24jvrR4ew_U",
        eventSources :[ 
            {
...
<div style="margin-left: 80px; width: 88%;">
	...
	<div id="wrapper1">
		...
		<input type="checkbox" id="allMyCal" class="calendar_checkbox" checked/>&nbsp;&nbsp;<label for="allMyCal">나의 일정</label>
		...
		<input type="checkbox" id="sharedCal" class="calendar_checkbox" value="0" checked/>&nbsp;&nbsp;<label for="sharedCal">공유일정</label> 
	</div>
      ...
      <div class="modal-body">
       	...
       	<table style="width: 100%;" class="table table-bordered">
     			...
     			<tr>
     				...
     				<td style="text-align: left; padding-left: 5px;">${sessionScope.loginuser.userid}</td>
     			</tr>
     		</table>
       	</form>	
      </div>
