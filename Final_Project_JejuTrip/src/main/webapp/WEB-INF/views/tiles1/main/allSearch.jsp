...
<div class="container" style="border: solid 1px red; width: 70%; margin: 0 auto;">
	<div class="mt-5 mb-5">
		<div style="border: solid 1px blue; margin-bottom: 7%;">
		...
		<div id="lodgingDiv">
			<span style="font-size: 1.2rem; font-weight: 600;">숙박&nbsp;<span class="font-weight-bold" style="font-size: 1rem; color: #ff7433;">52개</span></span>
		...
		<div id="foodstoreDiv" style="margin-top: 7%;">
			<span style="font-size: 1.2rem; font-weight: 600;">맛집&nbsp;<span class="font-weight-bold" style="font-size: 1rem; color: #ff7433;">37개</span></span>
